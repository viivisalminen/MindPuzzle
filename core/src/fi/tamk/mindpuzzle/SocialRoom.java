...
public class SocialRoom extends ScreenAdapter {
    ...
    private void initButtons() {
        ...
        character1Button.setPosition(app.VIRTUAL_WIDTH * 0.075f, app.VIRTUAL_HEIGHT * 0.5f);
        ...
        character2Button.setPosition(app.VIRTUAL_WIDTH * 0.05f, app.VIRTUAL_HEIGHT * 0.25f);
        ...
        character3Button.setPosition(app.VIRTUAL_WIDTH * 0.7f, app.VIRTUAL_HEIGHT * 0.6f);
        ...
        character4Button.setPosition(app.VIRTUAL_WIDTH * 0.375f, app.VIRTUAL_HEIGHT * 0.15f);
        ...
        character5Button.setPosition(app.VIRTUAL_WIDTH * 0.56f, app.VIRTUAL_HEIGHT * 0.3f);
