...
public class SocialRoom extends ScreenAdapter {
    ...
    public void show() {
        ...
        character1Txt = app.assets.get(
                "images/Characters/wizardcatFlipped.png", Texture.class);
        ...
        background.setBackground(new TextureRegionDrawable(
                new TextureRegion(app.assets.get(
                        "images/socialRoom.png", Texture.class))));
    ...
    private void initButtons() {
        ...
        character1Button.setPosition(app.VIRTUAL_WIDTH * 0.075f,
                app.VIRTUAL_HEIGHT * 0.5f);
        character1Button.setSize(character1Txt.getWidth() * 0.35f,
                character1Txt.getHeight() * 0.35f);
        ...
        character2Button.setPosition(app.VIRTUAL_WIDTH * 0.05f,
                app.VIRTUAL_HEIGHT * 0.25f);
        character2Button.setSize(character2Txt.getWidth() * 0.35f,
                character2Txt.getHeight() * 0.35f);
        ...
        character3Button.setPosition(app.VIRTUAL_WIDTH * 0.7f,
        ...
        character4Button.setPosition(app.VIRTUAL_WIDTH * 0.375f,
                app.VIRTUAL_HEIGHT * 0.15f);
        character4Button.setSize(character4Txt.getWidth() * 0.5f,
                character4Txt.getHeight() * 0.5f);
        ...
        character5Button.setPosition(app.VIRTUAL_WIDTH * 0.56f,
                app.VIRTUAL_HEIGHT * 0.3f);
        character5Button.setSize(character5Txt.getWidth() * 0.6f,
                character5Txt.getHeight() * 0.6f);
    ...
    public void resetCharacterInfo() {
        ...
        app.saveCharacter("social1",char5NotClicked);
        app.saveCharacter("social2",char5NotClicked);
        app.saveCharacter("social3",char5NotClicked);
        app.saveCharacter("social4",char5NotClicked);
        app.saveCharacter("social5",char5NotClicked);
    }
