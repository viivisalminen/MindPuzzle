...
public class SocialRoom extends ScreenAdapter {
     ...
     */
    public SocialRoom(final fi.tamk.mindpuzzle.MindPuzzle app) {
        this.app = app;
    ...
    private void initButtons() {
        ...
        character1Button.setPosition(fi.tamk.mindpuzzle.MindPuzzle.VIRTUAL_WIDTH * 0.075f, fi.tamk.mindpuzzle.MindPuzzle.VIRTUAL_HEIGHT * 0.5f);
        ...
        character2Button.setPosition(fi.tamk.mindpuzzle.MindPuzzle.VIRTUAL_WIDTH * 0.05f, fi.tamk.mindpuzzle.MindPuzzle.VIRTUAL_HEIGHT * 0.25f);
        ...
        character3Button.setPosition(fi.tamk.mindpuzzle.MindPuzzle.VIRTUAL_WIDTH * 0.7f, fi.tamk.mindpuzzle.MindPuzzle.VIRTUAL_HEIGHT * 0.6f);
        ...
        character4Button.setPosition(fi.tamk.mindpuzzle.MindPuzzle.VIRTUAL_WIDTH * 0.375f, fi.tamk.mindpuzzle.MindPuzzle.VIRTUAL_HEIGHT * 0.15f);
        ...
        character5Button.setPosition(fi.tamk.mindpuzzle.MindPuzzle.VIRTUAL_WIDTH * 0.56f, fi.tamk.mindpuzzle.MindPuzzle.VIRTUAL_HEIGHT * 0.3f);
