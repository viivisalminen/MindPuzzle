...
/**
 * FoodRoom shows the game's kitchen-themed room
 */
public class FoodRoom extends ScreenAdapter {
    /**
    ...
    public void show() {
        ...
        character2Txt = app.assets.get(
                "images/Characters/browncatFlipped.png", Texture.class);
        ...
        background.setBackground(new TextureRegionDrawable(
                new TextureRegion(app.assets.get(
                        "images/foodRoom.png", Texture.class))));
    ...
    private void initButtons() {
        ...
        character1Button.setPosition(app.VIRTUAL_WIDTH * 0.3f,
        ...
        character2Button.setPosition(app.VIRTUAL_WIDTH * 0.03f,
        ...
        character3Button.setPosition(app.VIRTUAL_WIDTH * 0.575f,
                app.VIRTUAL_HEIGHT * 0.45f);
        ...
        character4Button.setPosition(app.VIRTUAL_WIDTH * 0.25f,
    ...
    public void resetCharacterInfo() {
        ...
        app.saveCharacter("food1",char5NotClicked);
        app.saveCharacter("food2",char5NotClicked);
        app.saveCharacter("food3",char5NotClicked);
        app.saveCharacter("food4",char5NotClicked);
        app.saveCharacter("food5",char5NotClicked);
    }
