...
public class FoodRoom extends ScreenAdapter {
    ...
    public void show() {
        ...
        character1Txt = app.assets.get("images/Characters/bird.png", Texture.class);
        character2Txt = app.assets.get("images/Characters/browncatFlipped.png", Texture.class);
        character3Txt = app.assets.get("images/Characters/demoncat.png", Texture.class);
        character4Txt = app.assets.get("images/Characters/ghost.png", Texture.class);
        character5Txt = app.assets.get("images/Characters/fox.png", Texture.class);
