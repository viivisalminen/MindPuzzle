...
public class SleepRoom extends ScreenAdapter {
    ...
    /**
     * Initializes the character textures. Sets the previous
     * screen and plays the music if it is on.
     */
    @Override
    public void show() {
        ...
        character1Txt = app.assets.get(
                "images/Characters/griffinredFlipped.png", Texture.class);
        character2Txt = app.assets.get(
                "images/Characters/robotcatFlipped.png", Texture.class);
        ...
        background.setBackground(new TextureRegionDrawable(
                new TextureRegion(app.assets.get(
                        "images/sleepRoom.png", Texture.class))));
    ...
    private void initButtons() {
        ...
        character1Button.setSize(character1Txt.getWidth() * 0.4f,
                character1Txt.getHeight() * 0.4f);
        ...
        character2Button.setSize(character2Txt.getWidth() * 0.4f,
                character2Txt.getHeight() * 0.4f);
        ...
        character3Button.setPosition(app.VIRTUAL_WIDTH * 0.6f,
                app.VIRTUAL_HEIGHT * 0.075f);
        character3Button.setSize(character3Txt.getWidth() * 0.5f,
                character3Txt.getHeight() * 0.5f);
        ...
        character4Button.setPosition(app.VIRTUAL_WIDTH * 0.575f,
                app.VIRTUAL_HEIGHT * 0.55f);
        character4Button.setSize(character4Txt.getWidth() * 0.4f,
                character4Txt.getHeight() * 0.4f);
        ...
        character5Button.setPosition(app.VIRTUAL_WIDTH * 0.5f,
                app.VIRTUAL_HEIGHT * 0.375f);
        character5Button.setSize(character5Txt.getWidth() * 0.4f,
                character5Txt.getHeight() * 0.4f);
    ...
    public void resetCharacterInfo() {
        ...
        app.saveCharacter("sleep1",char5NotClicked);
        app.saveCharacter("sleep2",char5NotClicked);
        app.saveCharacter("sleep3",char5NotClicked);
        app.saveCharacter("sleep4",char5NotClicked);
        app.saveCharacter("sleep5",char5NotClicked);
    }
