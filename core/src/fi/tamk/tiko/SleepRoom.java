...
public class SleepRoom implements Screen {
    ...
    public void show() {
        ...
        pixel2Txt = app.assets.get("images/Pixelarts/pixelart3.png", Texture.class);
        pixel3Txt = app.assets.get("images/Pixelarts/pixelart6.png", Texture.class);
        pixel4Txt = app.assets.get("images/Pixelarts/pixelart9.png", Texture.class);
        pixel5Txt = app.assets.get("images/Pixelarts/pixelart11.png", Texture.class);
