...
public class SportsRoom extends ScreenAdapter {
    ...
    private void initButtons() {
        ...
        character1Button.setPosition(MindPuzzle.VIRTUAL_WIDTH * 0.15f,MindPuzzle.VIRTUAL_HEIGHT * 0.6f);
        ...
        character2Button.setPosition(MindPuzzle.VIRTUAL_WIDTH * 0.025f,MindPuzzle.VIRTUAL_HEIGHT * 0.35f);
        ...
        character3Button.setPosition(MindPuzzle.VIRTUAL_WIDTH * 0.65f,MindPuzzle.VIRTUAL_HEIGHT * 0.25f);
        ...
        character4Button.setPosition(MindPuzzle.VIRTUAL_WIDTH * 0.35f,MindPuzzle.VIRTUAL_HEIGHT * 0.15f);
        ...
        character5Button.setPosition(MindPuzzle.VIRTUAL_WIDTH * 0.65f,MindPuzzle.VIRTUAL_HEIGHT * 0.575f);
